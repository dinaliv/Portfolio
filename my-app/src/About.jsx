    ...
    <section id="about" className="flex flex-col gap-8 scroll-mt-32">
      ...
      <div className="flex flex-col gap-5">
        <p className="font-body text-lg leading-relaxed text-neutral-700">
          Hi there! I'm Diana, a third-year Interactive Arts and Technology student at SFU, minoring in Computing Science. I recently completed my Associate's degree in Computer Science, building a strong foundation in data structures, algorithms, linear algebra, and mathematics.
        </p>
        <p className="font-body text-lg leading-relaxed text-neutral-700">
          On the technical side, I'm experienced with C++, Java, JavaScript, React, and React Three Fiber. I'm also deeply passionate about art and 3D graphics, working proficiently with tools like Blender, Maya, Substance Painter, 3D Coat, and ZBrush — with a particular strength in hand-painted textures.
        </p>
        <p className="font-body text-lg leading-relaxed text-neutral-700">
